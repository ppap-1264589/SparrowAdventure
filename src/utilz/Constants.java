...
public class Constants {
	...
	public static class Projectiles {
		...
		public static final int PROJECTILES_DAMAGE = -15;
	}
...
//		public static final int TREE_THREE = 9;
	...
	public static class EnemyConstants {
		...
		//Kích cỡ của Crabby là 72 theo chiều ngang, hitbox thực sự của Crabby cách biên bên trái của ảnh vẽ khoảng 26 pixel
	...
	//Các thông số cho Buttons của Menu
	public static class UI {
		...
		public static class VolumeButtons {
			...
			//Kích cỡ của nút kéo thả Volume
			public static final int VOLUME_WIDTH = (int) (VOLUME_DEFAULT_WIDTH * Game.SCALE);
			public static final int VOLUME_HEIGHT = (int) (VOLUME_DEFAULT_HEIGHT * Game.SCALE);
			
			//Độ dài của Thanh ngang Volume
